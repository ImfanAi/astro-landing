...
export default function Intro() {
   return (
      <section id="About">
         <div className="relative w-full h-full flex flex-col justify-center items-center text-center 2xl:pt-40 xl:pt-20 lg:pt-16 md:pt-10 pt-6 xl:pb-32 lg:pb-24 md:pb-20 pb-6 font-[family-name:var(--font-geist-mono)">
