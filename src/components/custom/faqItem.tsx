...
export default function FaqItem(props: FaqProps) {
   ...
   return (
      <div className={`flex flex-row w-full mx-auto justfiy-between border border-[#E15025] ${!showAnswer ? 'rounded-full' : 'md:rounded-[60px] rounded-3xl bg-[#962E7133] bg-opacity-10 backdrop-blur-sm'} items-center h-full xl:px-12 lg:px-8 lg:py-11 px-10 py-4`}>
